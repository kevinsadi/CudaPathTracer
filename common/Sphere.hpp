...
public:
    ...
    Material* material;
    float area;
    Sphere(const Vector3f &c, const float &r, Material* mt = new Material()) : center(c), radius(r), radius2(r * r), m(mt), area(4 * Pi *r *r) {}
    ...
    __host__ __device__ Intersection getIntersection(Ray ray) {
        Intersection result;
